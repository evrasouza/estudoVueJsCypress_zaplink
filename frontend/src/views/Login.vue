      ...
      <div class="hero-body">
        <div class="columns">
            ...
            <div class="card login">
              <div class="card-content">
                <form>
                  ...
                  <div class="field">
                    <p class="control">
                      <button id="signIn" type="button" @click="login()" class="button is-success">Entrar</button>
                    </p>
                  </div>
                </form>
              </div>
          ...
          <div class="column is-6">
            <img src="../assets/landing.svg" alt="Marca" width="100%" />
          </div>
        </div>
      </div>
    </section>
  ...
  methods: {
    login() {
      ...
      window.axios
        ...
        .catch((error) => {
          this.alertError = 'Email e/ou senha incorretos!'
        })
    },
  },
};
